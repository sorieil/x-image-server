...
exports.checkTargetAccountIdEventIdExistFromParams = exports.checkTargetAccountIdEventIdExistFromBody = void 0;
 ...
 */
exports.checkTargetAccountIdEventIdExistFromBody = () => {
    return express_validator_1.body('targetAccountId').custom((value, { req }) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        Object.assign(req.user, { targetAccount: authQuery });
        if (authQuery === null) {
            return Promise.reject('존재하지 않거나, 참여 회원이 아닙니다.');
        }
    }));
};
exports.checkTargetAccountIdEventIdExistFromParams = () => {
    return express_validator_1.param('targetAccountId').custom((value, { req }) => __awaiter(void 0, void 0, void 0, function* () {
        const serviceAuth = new ServiceAuth_1.default();
        const account = new MongoAccounts_1.Accounts();
        const accountsEvent = new MongoAccounts_1.AccountsEvent();
        accountsEvent._id = req.user.eventId;
